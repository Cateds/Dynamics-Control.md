...
- 会提高系统阶数
- $K_i$ 太大会降低阻尼，使响应振荡加剧
- 对稳定性的影响不能只看直觉，最好还是回到特征方程或者劳斯判据
...
这部分的核心仍然是：PI 可以消除稳态误差，但由于引入了积分环节，系统阶数提高，稳定性要重新判断。
...
所以，PID 对二阶系统同样会引入一个三阶特征方程。它是工程上非常常用的控制器，但不是“套上就好”的万能药，最后仍然要回到闭环极点、稳定裕度和实际响应上看效果。

## 小结

这一讲主要把 P、D、I 这些基本控制作用组合了一遍：

- PD：改善瞬态响应和阻尼，但一般不能消除稳态误差
