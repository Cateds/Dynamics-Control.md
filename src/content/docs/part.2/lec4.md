...
这一讲基本是 [Lec.3](./lec3.md) 的续集：继续画 Bode 图，并且加入二阶共轭项、延迟项，以及用实验频率响应反推传递函数。
...
这一讲的重点是把 Bode 图从“会画基本组件”推进到“能处理实际例题”：

- 先化成时间常数形式，再拆组件
- 重复极点会让斜率和相位变化叠加
- 二阶共轭项的 corner frequency 是 $\omega_n$
- 延迟项幅值不变，但相位会随频率线性下降
- 实验频率响应可以用渐近线拟合得到近似传递函数
