...
PPT 最后强调了一点：这些裕度指标通常只对开环稳定系统比较直接有效。
...
这一讲把稳定性从时域和极点位置推进到了频域：

- 极点在左半平面通常意味着稳定
- Routh-Hurwitz 可以不用求根判断右半平面极点数量
- 频域稳定边界对应 $G(j\omega)=-1$
- 相位裕度在 $0\text{ dB}$ 处看相位离 $-180^\circ$ 多远
- 增益裕度在 $-180^\circ$ 处看幅值离 $1$ 还有多远
